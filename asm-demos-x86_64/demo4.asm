; Assemble:	nasm -f elf demo4.asm
; Link:		gcc -o demo4 demo4.o
; Run:		./demo4
;
...
.str	db	%1,0		; %1 is first actual in macro call
	...
	mov	r8d, dword [c]	; int c
	mov	ecx, dword [b]	; int b 
	mov	edx, dword [a]	; int a
	mov	esi, .str 	; users string
        mov	edi, fmt       ; address of format string
